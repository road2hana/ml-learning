...
for k in K:
    ...
    common.plot(X, mixtures[min_cost_seed_i], posts[min_cost_seed_i], "k-mean k:"+str(k)+" seed:"+str(min_cost_seed_i))
...
for k in K:
    ...
    common.plot(X, mixtures[min_cost_seed_i], posts[min_cost_seed_i], "EM k:"+str(k)+" seed:"+str(min_cost_seed_i))
    print(k, cost, min_cost_seed_i)